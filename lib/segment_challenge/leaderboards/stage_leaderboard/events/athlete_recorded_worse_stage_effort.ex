defmodule SegmentChallenge.Events.AthleteRecordedWorseStageEffort do
  alias SegmentChallenge.Events.AthleteRecordedWorseStageEffort
  ...
  defimpl Commanded.Serialization.JsonDecoder do
    ...
    def decode(%AthleteRecordedWorseStageEffort{} = event) do
